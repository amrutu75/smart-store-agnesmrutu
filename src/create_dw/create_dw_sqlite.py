...
from create_dw.utils_logger import logger
...
def populate_dw() -> None:
    ...
    try:
        ...
        df_customers = pd.read_csv(DATA_PREPARED_DIR / "customers_data_prepared.csv")
        ...
        df_products = pd.read_csv(DATA_PREPARED_DIR / "products_data_prepared.csv")
        ...
        df_sales = pd.read_csv(DATA_PREPARED_DIR / "sales_data_prepared.csv")
